...
| Dashboard | Übersichtseite mit zentralen Kennzahlen wie Saldo, Kategorienübersicht, letzte Transaktionen | Übersicht
...
| Dauerauftrag | Wiederkehrende automatisch ausgeführte Transaktion | Wiederkehrende Transaktion
...
| Notgroschen | Einstellbarer Betrag, welcher immer auf dem Konto zur Verfügung stehen sollte | Notreserve, Rücklage
| Delta | Unterschied zwischen Einnahmen und Ausgaben über einen bestimmten Zeitraum  | Differenz, Abstand
| Verfügbares Kapital | Nach Abzug der Fixkosten freiverwendbares Kapital des aktuellen Monats  | Anteil nach Fixkosten, Nettokapital
|===
...
| MVP | Minimum Viable Product | Minimale funktionsfähige Version eines Produkts
...
| XLSX | Office Open XML Spreadsheet | Excel-Dateiformat; wird im Import-Kontext erwähnt
| TXT | Textdatei | Standard-Text-Format; wird im Import-Kontext erwähnt
|===
...
| Objekt
| Betrag muss numerisch und ≥ 0 sein, Datum gültig formatiert
| Buchung

| Wiederkehrende Transaktion
| Automatisch widerholender Finanzvorgang, entweder Einnahme oder Ausgabe
| Objekt
| Betrag muss numerisch und ≥ 0 sein, Datum gültig formatiert
| Buchung
