...
* Einstellungen anpassen für Daueraufträge, Kategorien und generelle Konfigurationen
* Fixe Ein-/Auszahlungen für den jetzigen Monat mit dem verbleibenden Budget
* Kontotandübersicht im Monatsvergleich
