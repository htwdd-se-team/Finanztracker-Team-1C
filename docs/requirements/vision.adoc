...
Die Verfeinerung des Stakeholders (Nutzer*innen), die das System benutzen, wird im UX-Konzept mittels Personas vorgenommen.
...
| Muss 
a| 
- Minimalistisches, visuell ansprechendes Dashboard (Saldo, Kategorien, letzte Einträge) 
| MVP 

| Übersichtliche tabellarische Anzeige
| Muss
a|
- Filter anbieten (Kategorien, Datum, Betrag)
- Speicherbare Filter
| MVP 

| Analysemöglichkeiten für datenaffine Nutzer 
| Soll 
a| 
- Filter- & Drill-Down-Ansichten 
- CSV/Excel-Import 
- Graphen und Visualisierungen
- Transaktionshistorie und Balance-Verlauf
| Release 1 

| Wiederkehrende Transaktionen
| Soll
a|
- Automatische Wiederholung von Einträgen (monatlich und jährlich)
- Verwaltung wiederkehrender Buchungen
| Release 1 
...
| XXX
| Warnungen & Benachrichtigungen zum „Denken abnehmen" 
| Kann 
a|
- Regelbasierte Benachrichtigungen/Vorhersagen 
| XXX
...
| Kann
| - Nach Sprache-Umstellung auch Möglichkeit automatische Umrechnung in die Heimatwährung
| XXX
|===
...
| Mobile Responsivität & Touch-Optimierung
| Hoch 
| Release 1

| Dokumentation: In-App-Hilfe
| Mittel
| Release 1
