...
* Lebt in Dresden
* Nutzt hauptsächlich iPhone & iPad (5 h/Tag Handy, 3 h Tablet „Lernen")
...
* Introvertierter (3/10), innovationsoffen (9/10), eher risiko­scheu (8/10)
* Hat bereits Tools getestet
* Spielt & programmiert gern
* Desktop‑Power‑User (5 h/Tag PC, 1 h Handy)
