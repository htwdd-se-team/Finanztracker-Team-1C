...
* Liebt übersichtlichen, sauben Code nach ISO-Standarts
...
* Benutzt Computer und Smartphone nur noch selten außerhalb der Uni
a| * Ist für seine Studenten verantwortlich
* Hat wenig Zeit um auf Emails zu antworten
* Benutzt selbst nur Excel für die Verwaltung seiner Finanzen
