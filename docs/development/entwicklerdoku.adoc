...
+
----
pnpm -C src/frontend dlx typedoc --entryPointStrategy expand --entryPoints app components hooks lib api __generated__ --tsconfig tsconfig.json --out docs/typedoc
----
